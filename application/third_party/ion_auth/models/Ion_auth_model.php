...
class Ion_auth_model extends CI_Model
{
     ...
     * @param null|string $ip_address IP address
    ...
    /**
     * @param array|int|string $check_group group(s) to check
     * @param bool|int|string  $id          user id
     ...
     * add_to_group
     *
     * @param array|float|int|string $group_ids
     * @param bool|float|int|string  $user_id
     *
     * @return int
     * @author Ben Edmunds
     */
     ...
     * remove_from_group
     *
     * @param array|bool|float|int|string $group_ids
     * @param bool|float|int|string $user_id
     *
     * @return bool
     * @author Ben Edmunds
     ...
     * create_group
     *
     * @param bool|string $group_name
     * @param string      $group_description
     * @param array       $additional_data
     *
     * @return bool|int The ID of the inserted group, or FALSE on failure
     * @author aditya menon
     */
     ...
     * update_group
     *
     * @param bool|int|string $group_id
     * @param bool|string     $group_name
     * @param array    $additional_data
     *
     * @return bool
