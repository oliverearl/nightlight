...
class Ion_auth
{
     ...
     *
     * @return array|bool|int The new user's ID if e-mail activation is disabled or Ion-Auth e-mail activation was
    ...
    /**
     * @return null|int The user's ID from the session user data or NULL if not found
     * @author jrmadsen67
     **/
